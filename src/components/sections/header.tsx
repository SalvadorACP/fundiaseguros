...
export function Header() {
  return (
    <header className="flex items-center justify-between px-6 py-6 sm:px-10 lg:px-16">
      <a href="#inicio" aria-label="Fundia Seguros, inicio" className="relative block h-10 w-36">
        <Image src="/images/branding/Fundia_horizontal.png" alt="Fundia Seguros" fill className="object-contain object-left" priority />
      </a>
